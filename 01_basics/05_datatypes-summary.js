...
// ++++++++++++++++ memory types +++++++++++++
// 1.stack - it is use in primative datatypes(jo bhi variable declare krte ha uska copy milta ha

// 2.heap - it is use in non primative datatypes(jo bhi variable declare krte ha uska reference milta hai)

let myyoutubename = "abhinav kartik"
...
let userOne = {
  email: "rishu349394@gmail.com",
  upi: "abhi4943e458@oksbi",
}

let usertwo = userOne

usertwo.email  = "abhi434@gmail.com"
...
// let student = ["snkik","abhinav","raj" ]
// console.log(typeof(student)); its output is object
